...
from test_api_app import models
from test_api_app import permissions
...
class HelloApiView(APIView):
    ...
    def post(self, request):
        ...
        if serializerr.is_valid():
            ...
            return Response(serializerr.errors,
...
class HelloViewSets(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        if serializer_.is_valid():
            name = serializer_.validated_data.get('name')
            message = f'Hello {name}'
            return Response({'message': message})
        else:
            return Response(
...
class UserProfileViewSet(viewsets.ModelViewSet):
    """Handle ccreating and updating profiles"""
